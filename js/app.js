...
if (!play) {
    ...
    ques7();
    if (Number(count) === 0) {
        alert('I guess this means we need to get to know each other better, you got all the questions wrong!');
    } else if (Number(count) > 0 && Number(count) < 4) {
        alert('At least it\'s not a zero! Your score is ' + Number(count) + ' out of 7');
    } else if (Number(count) > 3 && Number(count) < 7) {
        alert('You did great! Your score is ' + Number(count) + ' out of 7');
    } else if (Number(count) === 7) {
        alert('Looks like you already know me! Your score is ' + Number(count) + ' out of 7');
    } else {
